...
author: "Nadun Kulasekera Mudiyanselage"
...
*Observations*:
There are 3793 rows (cases) and 5 columns (variables)
-   

\*What other variables might we include? number of repeated words in tweets\*\* This is a great question to
...
The percentage of false and correct, i.e., false here is roughly 13 and true is 87 precent.
-   
...
-   
The percentage of false and correct, i.e., false here is roughly 13 and true is 87 precent - rounded to the third decimal.
-   
